...
public:
  ...
  double pdf_gaussian_discrete(const uint8_t&, const double&);

  // the CDF of a gaussian rounded to the integers
  double cdf_gaussian_discrete(const uint8_t, const uint8_t, const double&);
  ...
  void trunc_coeff_print(double **Ct, int dspin);
